...
<html lang="en">
  <head>
    ...
    <title>Library Student Portal - Staff Login</title>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="./stafflogin.php">Staff Login</a>
            </li>
            <li class="nav-item">
    ...
    <div class="login-container container-fluid container-md p-0 my-3">
      <div class="row g-0 h-100">
        <div class="col-md-6 bg-dark text-white p-4 p-md-5 d-flex flex-column justify-content-center">
          ...
          <p class="mb-4">Enter your staff account details</p>
          <form id="login-form" method="post">
            ...
            <button type="submit" class="btn btn-primary w-100" style="background-color: #a100ff; border: none;" id="signInBtn">Sign In</button>
          </form>
        </div>
        <div class="col-md-6 bg-primary text-white p-4 p-md-5 d-none d-md-flex flex-column justify-content-center align-items-center" style="background-color: #a100ff;">
          <h1 class="fs-1 fw-bold mb-3 text-center">Welcome to Library Staff Portal</h1>
          <p class="fs-6 opacity-75 text-center">Login to access your staff account</p>
          <img src="./staff.png" class="img-fluid mt-3" style="max-width: 200px;" alt="Staff illustration">
        </div>
      </div>
    </div>
